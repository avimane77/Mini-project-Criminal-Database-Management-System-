...
<body>
    ...
    <div class="main">
        <form action="register1.php" method="post" autocomplete="off">
         ...
         <h2 class="name">Institute name</h2>
         ...
         <option  name="postp" value="Inspector">Bsc</option>
         <option  value="IPS">Msc</option>
    ...
    <input  class="company" type="password" name="password" id="password" required >
    <h2 class="name" >Re_enter password</h2>
    <input  class="company" type="password" required >
...
$sql="INSERT INTO `register1` (`fname`, `lname`, `station`, `email`, `password`) VALUES ('$fname', '$lname', '$station', '$email', '$password') ";
