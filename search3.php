...
<body>
        <div class="main">
        <form action="search3.php" method="post" autocomplete="off" >
		<input type="text" name="get_id" placeholder="Enter the Police station...">
...
$query ="select * from criminal where station='$str' ";
