...
<body>
    ...
    <div class="main">
        <form action="addfir.php" method="post" autocomplete="off">
            
         <h2 class="name">Police Station name</h2>
         <input class="company" type="text" name="station">
         ...
         <option  disable="disable" selected="selected" value="">--Choose option</option>
         ...
         <input class="company" type="text" name="city">
         <h2 class="name">Postal Code</h2>
         <input class="company" type="text" name="postalcode">
         <h2 class="name">Date</h2>
         <input class="company" type="date" name="date">
         <h2 class="name">Phone number</h2>
         <input class="company" type="text" name="phone">
         <h2 class="name">Email-id</h2>
         <input class="company" type="text" name="email">
         <h2 class="name">Your Complaint</h2>
         <input class="company" type="text" name="complaint">
         <h2 class="name">FIR id</h2>
         <input class="company" type="text" name="firid">
...
$sql="INSERT INTO `criminal` (`station`, `name`, `complainttype`, `address`, `city`, `postalcode`, `date`, `phoneno`, `email`, `complaint`, `firid`) VALUES ('$stationname', '$name', '$type', '$address', '$city', '$postalcode', '$date', '$phone', '$email', '$complaint', '$firid')";

if($conn->query($sql)==true){
    echo "<script>alert('FIR added successfully ')</script>";
