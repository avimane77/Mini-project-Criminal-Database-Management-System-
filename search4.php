...
<body>
        <div class="main">
        <form action="search4.php" method="post" autocomplete="off" >
		<input type="text" name="get_id" placeholder="Enter the crime...">
...
$query ="select * from criminal where complainttype='$str' ";
